...
public static class ImplicitReferenceConversions
{
    ...
    public static object ConvertToObject(Shape shape) => shape;
    ...
    /// <returns><see cref="object"/> object.</returns>
    public static object ConvertToObject(Circle circle) => circle;
    ...
    /// <returns><see cref="object"/> object.</returns>
    public static object ConvertToObject(Square square) => square;
    ...
    public static Shape ConvertToShape(Circle circle) => circle;
    ...
    /// <param name="square"><see cref="Square"/> object.</param>
    /// <returns><see cref="Shape"/> object.</returns>
    public static Shape ConvertToShape(Square square) => square;
    ...
    public static IColorable ConvertToIColorable(Square square) => square;
}
