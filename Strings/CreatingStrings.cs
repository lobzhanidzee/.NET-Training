...
public static class CreatingStrings
{
    ...
    {
        // TODO #4-1. Implement the method using the new operator.
        // See the new operator documentation page: https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/operators/new-operator
    ...
    {
        // TODO #4-2. Implement the method using String(Char, Int32) constructor
    ...
    {
        // TODO #4-3. Implement the method using String(Char[]) constructor
    ...
    {
        // TODO #4-4. Implement the method using String(Char[], Int32, Int32) constructor
