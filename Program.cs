...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            if (petCount < maxPets) Console.WriteLine($"We currently have {petCount} pets that need homes. We can manage {maxPets - petCount} more.");
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                do
                {
                    ...
                    if (readResult != null)
                    {
                        ...
                        if (animalSpecies != "dog" && animalSpecies != "cat") validEntry = false;
