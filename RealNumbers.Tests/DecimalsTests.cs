...
public class DecimalsTests
{
    ...
    public void ReturnDecimal52_ReturnsDecimal()
    {
        ...
        // Assert
        Assert.That(result, Is.EqualTo(0.000_000_1m));
    }
    ...
    public void ReturnDecimal53_ReturnsDecimal()
    {
        ...
        // Assert
        Assert.That(result, Is.EqualTo(-10_000.000_000_000_1m));
    }
    ...
    public void ReturnDecimal54_ReturnsDecimal()
    {
        ...
        // Assert
        Assert.That(result, Is.EqualTo(1_048_294_829_438_549_029_840_452_834.1m));
    }
    ...
    public void ReturnDecimal55_ReturnsDecimal()
    {
        ...
        // Assert
        Assert.That(result, Is.EqualTo(-30_492_996_837_502_378_502_387_459_851m));
    }
