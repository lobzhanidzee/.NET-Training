...
public class CharsCounterTests
{
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(null, null));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(string.Empty, null));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(null, null, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(string.Empty, null, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount(string.Empty, new char[] { 'a' }, -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount(string.Empty, new char[] { 'a' }, 0, -1));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount("aa", new char[] { 'a' }, 1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(null, null, 0, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => CharsCounter.GetCharsCount(string.Empty, null, 0, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount(string.Empty, new char[] { 'a' }, -1, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount(string.Empty, new char[] { 'a' }, 0, -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount("aa", new char[] { 'a' }, 1, 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => CharsCounter.GetCharsCount("aa", new char[] { 'a' }, 0, 1, -1));
    }
}
