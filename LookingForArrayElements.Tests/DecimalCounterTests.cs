...
public sealed class DecimalCounterTests
{
    ...
    {
        // Act
        int actual = DecimalCounter.GetDecimalsCount(ArrayWithFiveElements, Array.Empty<decimal[]>());
    ...
    public void DecimalCounter_OneOfTheRangesIsEmpty_ReturnValidResult()
    {
        ...
        // Act
        int actual = DecimalCounter.GetDecimalsCount(ArrayWithFiveElements, ranges);
    ...
    public void DecimalCounter_FifteenElementsOneRange_ReturnsResult()
    {
        ...
        // Act
        int actual = DecimalCounter.GetDecimalsCount(ArrayWithFifteenElements, ranges);
    ...
    {
        // Act
        int actual = DecimalCounter.GetDecimalsCount(ArrayWithFiveElements, Array.Empty<decimal[]>(), 0, 1);
    ...
    public void DecimalCounterWithStartIndexAndCount_OneOfTheRangesIsEmpty_ReturnValidResult()
    {
        ...
        // Act
        int actual = DecimalCounter.GetDecimalsCount(ArrayWithFiveElements, ranges, 0, 1);
    ...
    public int DecimalCounter_FiveElementsOneRange_ReturnsResult(int startIndex, int count)
    {
        ...
        // Act
        return DecimalCounter.GetDecimalsCount(ArrayWithFiveElements, ranges, startIndex, count);
    }
    ...
    public int DecimalCounter_FifteenElementsOneRange_ReturnsResult(int startIndex, int count)
    {
        ...
        // Act
        return DecimalCounter.GetDecimalsCount(ArrayWithFifteenElements, ranges, startIndex, count);
    }
