...
public sealed class FloatCounterTests
{
    ...
    {
        // Act
        int actual = FloatCounter.GetFloatsCount(ArrayWithNineElements, Array.Empty<float>(), Array.Empty<float>());
    ...
    {
        // Act
        int actual = FloatCounter.GetFloatsCount(ArrayWithNineElements, Array.Empty<float>(), Array.Empty<float>(), 0, 1);
