...
public sealed class WhileMethodsTests
{
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => WhileMethods.GetIndexOfChar(null, 'a'));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => WhileMethods.GetIndexOfChar(null, 'a', 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => WhileMethods.GetIndexOfChar(string.Empty, 'a', -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => WhileMethods.GetIndexOfChar(string.Empty, 'a', 0, -1));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => WhileMethods.GetLastIndexOfChar(null, 'a'));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => WhileMethods.GetLastIndexOfChar(null, 'a', 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => WhileMethods.GetLastIndexOfChar(string.Empty, 'a', -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => WhileMethods.GetLastIndexOfChar(string.Empty, 'a', 0, -1));
    }
