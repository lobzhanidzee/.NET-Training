...
public sealed class ForMethodsTests
{
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => ForMethods.GetIndexOfChar(null, 'a'));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => ForMethods.GetIndexOfChar(null, 'a', 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ForMethods.GetIndexOfChar(string.Empty, 'a', -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ForMethods.GetIndexOfChar(string.Empty, 'a', 0, -1));
    }
    ...
    {
        _ = Assert.Throws<ArgumentNullException>(() => ForMethods.GetLastIndexOfChar(null, 'a'));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentNullException>(() => ForMethods.GetLastIndexOfChar(null, 'a', 0, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ForMethods.GetLastIndexOfChar(string.Empty, 'a', -1, 0));
    }
    ...
    {
        // Act
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ForMethods.GetLastIndexOfChar(string.Empty, 'a', 0, -1));
    }
